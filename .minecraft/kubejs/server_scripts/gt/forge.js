ServerEvents.recipes(event => {
    ...
    gtr.dimensionally_transcendent_plasma_forge("gtlcore:transcendent_metal")
    ...
    gtr.dimensionally_transcendent_plasma_forge("gtlcore:crystal_matrix_plasma")
        .notConsumable("avaritia:infinity_catalyst")
    ...
    gtr.dimensionally_transcendent_plasma_forge("gtlcore:magneto_hydro_dynamically_con_strained_star_matter")
    ...
    gtr.dimensionally_transcendent_plasma_forge("gtlcore:hypercube_1")
        .itemInputs("16x gtceu:transcendent_metal_rod", "gtlcore:quantum_anomaly")
    ...
    gtr.stellar_forge("gtlcore:astral_titanium_plasma")
    ...
    gtr.stellar_forge("gtlcore:celestial_tungsten_plasma")
        .itemInputs("gtlcore:naquadria_charge")
    ...
    gtr.stellar_forge("gtlcore:crystal_matrix_plasma")
    ...
    gtr.stellar_forge("gtlcore:quantum_chromo_dynamically_confined_matter_plasma")
    ...
    gtr.stellar_forge("gtlcore:dragon_heart")
        .itemInputs("gtlcore:naquadria_charge", "64x minecraft:dragon_egg", "gtceu:double_awakened_draconium_plate")
    ...
    gtr.nano_forge("gtlcore:cosmic_neutronium_nanoswarm")
        .notConsumable("gtceu:black_glass_lens")
        .itemInputs("8x gtceu:cosmic_neutronium_block", "32x gtlcore:optical_soc", "32x gtlcore:exotic_wafer", "16x gtlcore:cosmic_ram_wafer", "8x gtlcore:cosmic_processing_unit_core")
    ...
    gtr.nano_forge("gtlcore:transcendent_metal_nanoswarm")
        .notConsumable("kubejs:non_linear_optical_lens")
        .notConsumable("gtlcore:hypercube")
        .itemInputs("gtceu:rhenium_nanoswarm", "8x gtceu:transcendent_metal_block", "8x gtlcore:recursively_folded_negative_space", "#gtceu:circuits/max")
